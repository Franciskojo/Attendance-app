...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      secondary:
        "bg-slate-800 text-white hover:bg-slate-900 focus:ring-slate-700 dark:bg-slate-700 dark:hover:bg-slate-600",
      outline:
        "border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 shadow-sm focus:ring-slate-300 dark:border-slate-700 dark:bg-slate-800/80 dark:hover:bg-slate-800 dark:text-slate-200",
      danger:
